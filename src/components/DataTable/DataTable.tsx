            ...
            >
                ...
                {rowSelfTests && (
                    <Tooltip title={"AED Self Tests"}>
                        <IconButton sx={{
                            opacity: row?.original?.internalTestResult === "NoWifi" ? '50%' : '100%',
                            cursor: row?.original?.internalTestResult === "NoWifi" ? 'not-allowed !important' : 'pointer'
                        }}
                                    onClick={async (e) => {
                                        e.stopPropagation();
                                        if (row?.original?.internalTestResult !== "NoWifi")
